...
if ($textmode == "html") 
  {
    ...
    (1, 0, 1, 'news', '', '', '', '', '', '', '', '', '', '', '', 'Welcome !', '...', 'Congratulations, your website is up and running !<br />\r\n<br />\r\nThe next step is to go in the <a href=\"admin.php\">Administration panel</a>, tab <a href=\"admin.php?m=config\">Configuration</a>, and there tweak the settings for the system.<br />\r\nYou''ll find more instructions and tutorials in the <a href=\"https://www.seditiocms.com/dokumanlar/\">Documentation page for Seditio at Seditiocms.com</a>, and technical support in our <a href=\"https://www.seditiocms.com/destek/\">discussion forums</a>.', 1, '', '', 1, 1263945600, 1263942000, 1861959600, 0, '', '', 38, 1, 1, 0.00, 0, 0, '', '', '', '', '');");
  }
else
  {
    $sql = sed_sql_query("INSERT INTO ".$cfg['mysqldb']."pages VALUES
    (1, 0, 0, 'news', '', '', '', '', '', '', '', '', '', '', '', 'Welcome !', '...', 'Congratulations, your website is up and running !\r\n\r\nThe next step is to go in the [url=admin.php]Administration panel[/url], tab [url=admin.php?m=config]Configuration[/url], and there tweak the settings for the system.\r\nYou''ll find more instructions and tutorials in the [url=https://www.seditiocms.com/dokumanlar/]Documentation page for Seditio at Seditiocms.com[/url], and technical support in our [url=https://www.seditiocms.com/destek/]discussion forums[/url].', 0, '', '', 1, 1263945600, 1263942000, 1861959600, 0, '', '', 27, 1, 1, 0.00, 0, 0, '', '', '', '', '');");
  }
